...
<head>
  ...
  <!-- nakatahanger.com グローバル CSS -->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=EB+Garamond:400,400i">
  <link rel="stylesheet" href="https://fonts.googleapis.com/earlyaccess/sawarabimincho.css">
  <link rel="stylesheet" type="text/css" href="https://www.nakatahanger.com/common/common.css?nc=202601271545">
  <link rel="stylesheet" type="text/css" media="(max-width:768px)" href="https://www.nakatahanger.com/common/common-s.css?nc=202601271545">
  <link rel="stylesheet" type="text/css" media="(min-width:769px)" href="https://www.nakatahanger.com/common/common-l.css?nc=202601271545">

  <!-- nakatahanger.com グローバル JS -->
  <script type="text/javascript" src="https://www.nakatahanger.com/lib/jquery-3.3.1.min.js?nc=202601271545"></script>
  <script type="text/javascript" src="https://www.nakatahanger.com/lib/iscroll.min.js?nc=202601271545"></script>
  <script type="text/javascript" src="https://www.nakatahanger.com/lib/drawer.min.js?nc=202601271545"></script>
  <script type="text/javascript" src="https://www.nakatahanger.com/lib/_.js?nc=202601271545"></script>
  <script type="text/javascript" src="https://www.nakatahanger.com/common/nh.js?nc=202601271545"></script>

  <!-- LP フォント -->
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@200;300&family=Noto+Serif+JP:wght@200;300;400&display=swap" rel="stylesheet">
  <!-- LP CSS -->
...
<body lang="ja">
  ...
  <section id="scene-01">
    ...
    <div class="s1-hero">
      ...
      <img
        class="s1-img"
        src="images/o1gray5.png"
        alt="グレーバー SET-01を装着したクローゼット — スーツ5着が静かに並ぶ"
        loading="eager"
        decoding="async"
        width="1920"
        height="1080"
  ...
  <section id="solution" class="s-solution">
    <div class="s-solution-inner">

      <span class="scene-tag reveal">— 選択</span>
      <div class="hline reveal d1"></div>
      ...
      <div class="product-img-wrap reveal d4">
        <img
          class="product-img"
          src="images/o1gray5.2.png"
          alt="NAKATA HANGER SET-01 フェルトバー グレー 5本セット"
          loading="lazy"
          decoding="async"
          width="800"
          height="640"
      ...
      <div class="feature-grid reveal d4">
        <div class="feature-item">
          ...
          <h3 class="feature-title">ジャケットも、<br>ボトムも、一本で。</h3>
          <p class="feature-text">ジャケットを掛け、ボトムをバーに渡す。セットアップが一本にまとまり、翌朝そのまま手に取れる。</p>
        </div>
        <div class="feature-item">
          <span class="feature-num">02</span>
          <h3 class="feature-title">消えることで、<br>服が浮かぶ色。</h3>
          <p class="feature-text">強い色は、服と競い合う。グレーは競わない。だから、どんな服も引き立てる。</p>
        </div>
        <div class="feature-item">
          <span class="feature-num">03</span>
          <h3 class="feature-title">整えるための、<br>最小にして十分な数。</h3>
          <p class="feature-text">主力スーツの一列分。全部でなくていい。まず一列から。</p>
        </div>
      </div>

      <div class="cta-wrap reveal d4">
        <a
          href="https://www.nakatahanger-shop.com/?pid=190670905"
  ...
  <!-- ============================================================
       FOR-WHOM — 用途から選ぶ
  ============================================================ -->
  <section id="for-whom" class="s-for-whom">
    <div class="s-for-whom-inner">
      ...
      <div class="for-whom-grid reveal d2">
        ...
        <div class="for-whom-card">
          ...
          <h3 class="for-whom-card-title">新生活の、最初の支度として</h3>
          <p class="for-whom-card-text">新しい環境に踏み出すとき、スーツを守るハンガーから。クローゼットの背景を、最初に整える選択です。</p>
        </div>

        <div class="for-whom-card">
          <span class="for-whom-card-sub">贈り物</span>
          <h3 class="for-whom-card-title">旅立ちへの、実用的な贈り物として</h3>
          <p class="for-whom-card-text">相手の好みを問わず、日常の質だけを上げる。グレーは、そういう色です。</p>
        </div>

        <div class="for-whom-card">
          <span class="for-whom-card-sub">追加購入</span>
          <h3 class="for-whom-card-title">揃うほど、整っていく。</h3>
          <p class="for-whom-card-text">一本目が決まれば、あとは同じものを足すだけでいい。同色・同仕様だから、追加するたびにクローゼットが完成に近づく。</p>
        </div>
  ...
  <!-- ============================================================
       色の思想（共通）
  ============================================================ -->
  <section id="philosophy" class="s-philosophy">
    <div class="s-philosophy-inner">

      <span class="scene-tag reveal">整えるということ</span>
      <div class="hline reveal d1"></div>

      <h2 class="philosophy-h2 reveal d2">揃うと、<br>なぜか静かになる。</h2>

      <div class="body-text reveal d3">
        <p>特別なことは何もしていないのに、整って見えるクローゼットがある。</p>
        <p>色が揃っているだけで、全体が落ち着く。</p>
        <p>見えていないものが、整えている。</p>
      </div>
  ...
  <!-- ============================================================
       クロージング CTA #closing
  ============================================================ -->
  <section id="closing" class="s-closing">

    <span class="s-closing-eyebrow reveal">まずは、5本から。</span>

    <p class="s-closing-lead reveal d1">
      すべてを一度に変える必要はない。<br>
      一列を整えるだけで、景色は変わる。
    </p>
						...
						<div class="link-category-container">
							...
							<div class="list">
								<ul>
									...
									<li><a href="https://www.nakatahanger.com/en/france/">FRENCH</a></li>
								</ul>
							</div>
						</div>
					</li>
  ...
  <!-- ============================================================
       STICKY CTA BAR
  ============================================================ -->
  <div id="sticky-bar" class="sticky-bar" role="complementary" aria-label="購入導線">
    <span class="sticky-bar-text">SET-01GY / メンズスーツハンガー 5本組 / スモークブラウン / フェルトバー付（グレー）</span>
    <a
      href="https://www.nakatahanger-shop.com/?pid=190670905"
  ...
  (function () {
    ...
    var fvSection     = document.getElementById('scene-01');
    var closingSection = document.getElementById('closing');

    if (stickyBar && fvSection && closingSection) {
      var onScroll = function () {
        var fvBottom     = fvSection.getBoundingClientRect().bottom;
        var closingTop   = closingSection.getBoundingClientRect().top;
        var windowHeight = window.innerHeight;

        /* FVを過ぎてからクロージングに入るまで表示 */
        if (fvBottom < 0 && closingTop > windowHeight) {

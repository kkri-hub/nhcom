...
define("PRICE_PAPER_BAG", 300);
define("PRICE_NOSHI", 200);
...
define("GRAD_MAIN_IMAGE_PC", "grad-ogp.jpg");
define("GRAD_MAIN_IMAGE_SP", "grad-ogp.jpg");
...
$gradPublicLabels = array(
	...
	"email"=>"メールアドレス",
	"tel"=>"電話番号",
	"customerPosition"=>"ご担当者様 役職",
	"estimateContents"=>"お見積もり内容",
	"product"=>"商品",
	"counts"=>"予定本数",
//	"priceType"=>"早割希望",
	"estimateType"=>"ご希望のお見積もり",
...
$questionHowInformed = array(
	...
	"2"=>"他校のお知り合いからのご紹介",
	"3"=>"届いたカタログを見て",
	"4"=>"ギフトや記念品で以前貰ったことがある",
	"5"=>"NAKATA HANGER 公式サイト",
	"6"=>"NAKATA HANGER 青山ショールーム",
//	"7"=>"NAKATA HANGER 公式SNS（Instagram、X (Twitter)、Facebook、YouTube）",
	"9"=>"Instagram",
	"10"=>"X (Twitter)",
	"11"=>"Facebook",
	"12"=>"YouTube",
